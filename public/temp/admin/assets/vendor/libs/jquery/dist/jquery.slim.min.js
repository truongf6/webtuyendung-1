...
!(function (e, t) {
    ...
    !(function () {
        ...
        function I(t, e, n, r) {
            ...
            if (!r && (V(e), (e = e || C), T)) {
                ...
                if (!(h[t + ' '] || (p && p.test(t)))) {
                    if (
                        ((c = t), (f = e), 1 === d && (b.test(t) || m.test(t)))
                    ) {
                        ((f = (P.test(t) && X(e.parentNode)) || e) == e &&
                            le.scope) ||
                            ((s = e.getAttribute('id'))
                ...
                n != C &&
                    ...
                    (le.getById = F(function (e) {
                        return (
                            ...
                            !C.getElementsByName ||
                                !C.getElementsByName(ce.expando).length
                        );
                    })),
        ...
        (I.attr = function (e, t) {
            ...
            var n = x.attrHandle[t.toLowerCase()],
                r =
                    n && ue.call(x.attrHandle, t.toLowerCase())
                        ? n(e, t, !T)
                        : void 0;
        ...
        function te(e) {
            for (
                ...
                if ((t = x.relative[e[s].type])) c = [K(J(c), t)];
                    ...
                    if (
                        (t = x.filter[e[s].type].apply(null, e[s].matches))[k]
                    ) {
                        for (n = ++s; n < r; n++)
        ...
        function re(e, t, n, r) {
            ...
            if (((n = n || []), 1 === c.length)) {
                if (
                    ...
                    if (
                        !(t = (x.find.ID(a.matches[0].replace(H, q), t) ||
                            [])[0])
                    )
                        return n;
                    l && (t = t.parentNode),
    ...
    function Be(n, r, i, o) {
        ...
        if (
            h ||
            (1 < f && 'string' == typeof p && !le.checkClone && He.test(p))
        )
    ...
    ce.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        o = o || Ee(e), a = a || Ee(c), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        We(o[r], a[r]);
        ...
        ce.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (ce.cleanData(Ee(e, !1)), (e.textContent = ''));
                return this;
            },
            clone: function (e, t) {
                return (
                    ...
                    r ||
                        ...
                        (u &&
                            ...
                            e.isPropagationStopped() &&
                                f.addEventListener(p, vt),
                            n[p](),
                            e.isPropagationStopped() &&
                                f.removeEventListener(p, vt),
